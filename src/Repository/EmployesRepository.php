...
class EmployesRepository extends ServiceEntityRepository
{
    ...
    public function findByEstResponsable(bool $estResponsable, ?string $statut = null): array
    {
        $qb = $this->createQueryBuilder('e')
            ->where('e.estResponsable = :estResponsable')
            ->setParameter('estResponsable', $estResponsable);
        ...
        return $qb->orderBy('e.nomEmploye', 'ASC')
                  ->getQuery()
                  ->getResult();
    }
     ...
     */
    public function findOneByEmail(string $email): ?Employes
    {
        return $this->createQueryBuilder('e')
            ->where('e.emailEmploye = :email')
